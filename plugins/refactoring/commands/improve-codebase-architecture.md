...
Use [LANGUAGE.md](LANGUAGE.md) vocabulary for the architecture, and the codebase's own domain terms for the modules — not generic names like "FooBarHandler" or "the Order service."
